...
This somewhat scattered way of learning allowed me to slowly expand my skillset in many directions at once, and most importantly it was always while developing skills that were by default directly applicable to my work. But I also realize that back then if someone had said to me, "*Just use all these things you don't understand to do the things you don't know how to do and move on.*", I'd still be just as stuck – and left thinking that that person was not very helpful. I want this site to help bridge that gap – to help people to more quickly develop the baseline set of skills needed to do their work. After that, the sphere of capabilities can expand without there being a bottleneck on your science. 
