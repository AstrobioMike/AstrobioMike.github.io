...
This somewhat scattered way of learning allowed me to slowly expand my skillset in many directions at once – and most importantly it was always while developing skills that were by default directly applicable to my work. But I realize that back then if someone had simplysaid to me, "*Just use all these things you don't understand to do the things you don't know how to do and move on.*", I'd still be just as stuck – and left thinking that that person was not very helpful. 
