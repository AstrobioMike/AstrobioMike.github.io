...
>**NOTE:** Operators such as **`>`**, **`<`**, and **`>=`** as used in the above example are know as *relational operators*. These include: 
...
<center><img src="../images/R_vec_index_ge_6_not1.png" width="90%"></center> 
<br>
