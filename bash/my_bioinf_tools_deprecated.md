---
layout: main
title: Bioinformatics Tools (bit)
categories: [bash, tutorial]
permalink: /bash/my_bioinf_tools
---

{% include _bash_my_bioinf_tools_toc.html %}

{% include _side_tab_bash.html %}

These are some useful bioinformatics one-liners and scripts I use frequently enough that it's been worth it to me to have them instantly available everywhere. This repository is hosted over at [github here](), 
...
Many require [biopython](https://biopython.org/wiki/Download) (marked `*` in table below), and as of now one requires [pybedtools](https://pypi.org/project/pybedtools/) (marked `**`).
