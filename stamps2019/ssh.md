---
layout: main
title: Connecting to a remote computer with ssh
categories: [unix, tutorial]
permalink: /stamps2019/ssh
---

<hr style="height:10px; visibility:hidden;" />

> **Things covered here:**
> * Here we are going to look at how to connect to a remote computer from our command line using a program called `ssh` (**s**ecure **sh**ell).
...
To do this as covered below, you need to have a working [Unix-like environment](/unix/getting_unix_env).
